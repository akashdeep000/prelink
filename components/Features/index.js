...
export default function Features() {
  const data = [
    ...
    },
    {
      ...
      title: "Sharable Link",
      description:
        "You Can Share Link After You Fetch The Website's Link-Preview And Recipient Can See It Opening Thee Link.",
    },
  ];
  return (
    <>
      <div className="w-full mt-6 md:mt-16 lg:mt-20">
        ...
        <div className="px-8 py-20 grid md:grid-cols-2 justify-center gap-x-10 gap-y-16">
          {data.map((e) => {
